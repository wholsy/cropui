...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
			...
			yesBtn : {
				...
				click : function(e) {
					var geocoder = win.geocoder,
						...
						url = 'http://mapper.googleapis.com/mapper/api/staticmap';
		...
		var iframeHtml = ['<!doctype html><html><head>',
			...
			'</style>',
			'<script src="http://mapper.googleapis.com/mapper/api/js?sensor=false&language=' + self.langType + '"></script>',
			'<script>',
			'var map, geocoder;',
			'function initialize() {',
