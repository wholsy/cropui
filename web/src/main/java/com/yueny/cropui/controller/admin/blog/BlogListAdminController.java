...
public class BlogListAdminController extends BaseController {
	@Autowired
	private IArticleBlogManagerService articleBlogManagerService;
	@Autowired
	private IArticleManagerService articleManageService;
