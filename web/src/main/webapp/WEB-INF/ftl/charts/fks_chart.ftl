...
<html>
  <head>
	...
	<body ng-app="frontEnd" ng-controller="frontEndCtrl">
		...
		<script src="http://static.yueny.site/plugins/angular/angular.min.js"></script>
		<script src="http://static.yueny.site/plugins/marked/lib/marked.js"></script>
		<script src="http://static.yueny.site/plugins/angular-marked/dist/angular-marked.min.js"></script>
		<script src="http://static.yueny.site/plugins/d3/d3.v3.js"></script>
