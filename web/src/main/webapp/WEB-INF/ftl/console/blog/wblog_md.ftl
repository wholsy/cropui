...
<#-- editormd -->
<link rel="stylesheet" href="http://static.codealy.com/plugins/editor.md/css/editormd.css"/>
...
<#--
<#include "console/common/footer.ftl">
-->
</div>
...
<#-- editormd -->
<script src="http://static.codealy.com/plugins/editor.md/editormd.min.js"></script>
